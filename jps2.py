...
class Pathfinder():
    ...
    def _exploreDiagonal (self, startX, startY, directionX, directionY):
        ...
        while (True):
            ...
            if self.field [cur_x + directionX] [cur_y] == OBSTACLE and self.field [cur_x + directionX] [cur_y + directionY] != OBSTACLE:
                return (cur_x, cur_y)
            ...
            if self.field [cur_x] [cur_y + directionY] == OBSTACLE and self.field [cur_x + directionX] [cur_y + directionY] != OBSTACLE:
                return (cur_x, cur_y)
